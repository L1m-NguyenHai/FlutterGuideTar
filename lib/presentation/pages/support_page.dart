            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _FaqTile(
                    question: 'Làm thế nào để đổi giáo viên\nhướng dẫn?',
                    answer:
                        'Vào phần Hồ sơ > Cài đặt khoá học > Đổi giáo viên để chọn giảng viên mới phù hợp mục tiêu của bạn.',
                  ),
                  const SizedBox(height: 12),
                  const _FaqTile(
                    question: 'Chính sách hoàn tiền cho các khóa\nhọc Premium',
                    answer:
                        'Bạn có thể gửi yêu cầu hoàn tiền trong 7 ngày đầu tiên nếu chưa vượt quá 20% tiến độ khóa học.',
                  ),
                  const SizedBox(height: 12),
                  const _FaqTile(
                    question: 'Kết nối ứng dụng với Guitar điện\nqua MIDI',
                    answer:
                        'Bật Bluetooth/MIDI trên nhạc cụ, mở trang Công cụ > MIDI Connect và chọn thiết bị để ghép nối.',
                  ),
                  const SizedBox(height: 12),
                  const _FaqTile(
                    question: 'Tại sao tôi không nhận được mã\nxác nhận OTP?',
                    answer:
                        'Kiểm tra sóng di động, thư rác và thời gian chờ 60 giây. Nếu vẫn lỗi, dùng nút Chat với CSKH bên trên.',
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        const _CategoryCard(label: 'Báo lỗi', icon: Icons.warning_amber_rounded),
      ],
    );
  }
}
