  ...
  Future<void> _showPendingDialog() async {
    final shouldShowSuccess = await showDialog<bool>(
      ...
      builder: (dialogContext) => _PendingPaymentDialog(
        paymentCode: 'PAY-7XQ4-92LM-3K8V',
        amount: '63.000 VNĐ',
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: const [
                              TextSpan(text: 'Đơn hàng sẽ tự động thanh toán vào '),
                              TextSpan(
                                text: '06/06/2027',
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8),
                                    _PaymentInput(controller: _expiryController),
                                  ],
                                ),
                              ),
                              const SizedBox(width: 10),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              color: selected ? const Color(0xFFF79633) : const Color(0xFF8E8B88),
              size: 18,
            ),
            const SizedBox(width: 8),
            Text(
              label,
              style: GoogleFonts.plusJakartaSans(
                color: selected ? const Color(0xFFE8E7E6) : const Color(0xFF8E8B88),
                fontSize: 12,
                fontWeight: FontWeight.w500,
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(
        ...
        style: GoogleFonts.plusJakartaSans(color: Colors.white, fontSize: 18 * 0.8),
