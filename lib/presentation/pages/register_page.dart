...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void initState() {
    super.initState();
    _emailController.text = 'nghesi@guidetar.vn';
  }
  ...
  Future<void> _onContinue() async {
    ...
    switch (_currentStep) {
      case _RegisterStep.email:
        ...
        break;
      case _RegisterStep.emailReview:
        if (email == 'someexistingemail@gmail.com') {
          _showConflictModal(
            title: 'Email đã được sử dụng',
            message:
                'Địa chỉ email này đã được đăng ký cho một tài khoản khác. Vui lòng đăng nhập hoặc sử dụng email khác.',
            primaryActionText: 'Đăng nhập ngay',
            secondaryActionText: 'Thử email khác',
            onPrimaryPressed: () {
      ...
      case _RegisterStep.username:
        if (username == 'jack') {
          _showConflictModal(
            title: 'Nghệ danh này đã được sử dụng',
            message:
                'Tớ biết bạn đã thích và ấp ủ nghệ danh này nhiều lắm… nhưng tiếc là nó đã có người đăng ký và dùng trước rồi. Nghe hơi hụt hẫng thật đó',
            primaryActionText: null,
            secondaryActionText: 'Thử một nghệ danh khác',
            onSecondaryPressed: () {
              Navigator.of(context).pop();
