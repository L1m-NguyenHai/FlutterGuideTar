    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.music_note_rounded, color: Color(0xFFDF7100), size: 18),
  ...
  Widget _dot(double t) {
    ...
    return Opacity(
      ...
      child: const DecoratedBox(
        decoration: BoxDecoration(color: Color(0xFFFF9F4A), shape: BoxShape.circle),
...
class _AnimatedMessageBubbleState extends State<_AnimatedMessageBubble>
  ...
  Widget build(BuildContext context) {
    ...
    final bubbleColor = isAgent ? const Color(0xFF20201F) : const Color(0xFFDF7100);
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(left: isAgent ? 4 : 0, right: isAgent ? 0 : 4),
                  child: Text(
                    widget.message.time,
                    style: GoogleFonts.manrope(
                      color: const Color(0xFFADAAAA),
